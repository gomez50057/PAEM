  ...
  return (
    <section id='about' className="about-container">
      ...
      <div className="about_txt">
        ...
        <p>Las zonas metropolitanas son áreas donde varios municipios conectados conforman un continuo urbano, compartiendo actividades económicas, sociales y de infraestructura. La metropolización formaliza esta integración para mejorar la coordinación en temas clave como el desarrollo urbano, la movilidad y la gestión de servicios públicos. Esto permite la colaboración entre municipios para asegurar un crecimiento ordenado, sostenible y que mejore la calidad de vida de sus habitantes.</p>
